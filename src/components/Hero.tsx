...
const Hero = () => {
  ...
  return (
    <section ref={targetRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <motion.div 
        style={{ y: blob1Y }}
        className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-600/20 rounded-full blur-[100px] animate-pulse" 
      />
      <motion.div 
        style={{ y: blob2Y }}
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-600/10 rounded-full blur-[120px] animate-pulse delay-1000" 
      />
      ...
      >
        <div className="text-center">
          ...
          >
            <div className="glass p-5 rounded-3xl animate-float shadow-2xl shadow-accent/20 border-white/20">
          ...
          >
            <Magnetic>
              <a
                href="#projects"
                className="bg-accent hover:bg-accent/90 text-accent-foreground px-10 py-5 rounded-full font-bold flex items-center justify-center transition-all shadow-xl shadow-accent/30 group"
              >
                View Projects
            ...
            <Magnetic>
              <a
                href="#"
                className="glass hover:bg-white/20 text-foreground px-10 py-5 rounded-full font-bold flex items-center justify-center transition-all border-white/10"
              >
                Download Resume
